		...
		public Graph currentChildGraph{
			...
			set
			{
				if (Application.isPlaying && value != null && EditorUtility.IsPersistent(value)){
					CityParadoxNotion.Services.Logger.LogWarning("You can't view sub-graphs in play mode until they are initialized to avoid editing asset references accidentally", "Editor", this);
					return;
				}
