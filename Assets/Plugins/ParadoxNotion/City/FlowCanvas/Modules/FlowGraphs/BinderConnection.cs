...
namespace FlowCanvas{
	...
	public class BinderConnection : Connection {
		...
		[SerializeField] [CityParadoxNotion.Serialization.FullSerializer.fsProperty("_sourcePortName")]
		private string _sourcePortID;
		[SerializeField] [CityParadoxNotion.Serialization.FullSerializer.fsProperty("_targetPortName")]
		...
		public static BinderConnection Create(Port source, Port target){
			...
			if (verbose != null){
				CityParadoxNotion.Services.Logger.LogWarning(verbose, "Editor", source.parent);
				return null;
			}
		...
		public override CityParadoxNotion.PlanarDirection direction{ get {return CityParadoxNotion.PlanarDirection.Horizontal;} }
