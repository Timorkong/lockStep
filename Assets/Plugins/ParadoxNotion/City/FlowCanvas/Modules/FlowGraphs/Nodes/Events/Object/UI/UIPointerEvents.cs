...
namespace FlowCanvas.Nodes{
	...
	public class UIPointerEvents : MessageEventNode<Transform> {
		...
		void OnPointerDown(CityParadoxNotion.Services.MessageRouter.MessageData<PointerEventData> msg){
		...
		void OnPointerUp(CityParadoxNotion.Services.MessageRouter.MessageData<PointerEventData> msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
			this.eventData = msg.value;
		...
		void OnPointerEnter(CityParadoxNotion.Services.MessageRouter.MessageData<PointerEventData> msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
			this.eventData = msg.value;
			onPointerEnter.Call(new Flow());
		}

		void OnPointerExit(CityParadoxNotion.Services.MessageRouter.MessageData<PointerEventData> msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
			this.eventData = msg.value;
			onPointerExit.Call(new Flow());
		}

		void OnPointerClick(CityParadoxNotion.Services.MessageRouter.MessageData<PointerEventData> msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
			this.eventData = msg.value;
