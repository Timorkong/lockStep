...
namespace FlowCanvas.Nodes{
	...
	public class VisibilityEvents : MessageEventNode<Transform> {
		...
		void OnBecameVisible(CityParadoxNotion.Services.MessageRouter.MessageData msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
			onVisible.Call(new Flow());
		}

		void OnBecameInvisible(CityParadoxNotion.Services.MessageRouter.MessageData msg){
			this.receiver = ResolveReceiver(msg.receiver).gameObject;
