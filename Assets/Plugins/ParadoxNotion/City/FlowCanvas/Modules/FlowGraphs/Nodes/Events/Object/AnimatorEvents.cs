...
namespace FlowCanvas.Nodes{
	...
	public class AnimatorEvents : MessageEventNode<Animator> {
		...
		void OnAnimatorMove(CityParadoxNotion.Services.MessageRouter.MessageData msg){
			this.receiver = ResolveReceiver(msg.receiver);
			onAnimatorMove.Call(new Flow());
		}

		void OnAnimatorIK(CityParadoxNotion.Services.MessageRouter.MessageData<int> msg){
			this.receiver = ResolveReceiver(msg.receiver);
