...
namespace FlowCanvas.Nodes{
	...
	public class TransformEvents : MessageEventNode<Transform> {
		...
		void OnTransformParentChanged(CityParadoxNotion.Services.MessageRouter.MessageData msg){
		...
		void OnTransformChildrenChanged(CityParadoxNotion.Services.MessageRouter.MessageData msg){
			this.receiver = ResolveReceiver(msg.receiver);
			this.parent = receiver.parent;
			this.children = receiver.Cast<Transform>();
