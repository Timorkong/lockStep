...
namespace AINodeCanvas.DialogueTrees
{
    ...
    public class ProbabilitySelector : DTNode, ISubParametersContainer, ISubTasksContainer
    {
        ...
        void DrawOptionGUI(int i, float total) {
            ...
            AINodeCanvas.Editor.TaskEditor.TaskFieldMulti<ConditionTask>(childOptions[i].condition, DLGTree, (c) => { childOptions[i].condition = c; });
            EditorUtils.Separator();
            GUILayout.BeginHorizontal();
            AINodeCanvas.Editor.BBParameterEditor.ParameterField("Weight", childOptions[i].weight);
