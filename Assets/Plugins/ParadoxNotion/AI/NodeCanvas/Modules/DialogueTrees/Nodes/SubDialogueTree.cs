...
namespace AINodeCanvas.DialogueTrees
{
    ...
    public class SubDialogueTree : DTNode, IGraphAssignable, ISubParametersContainer
    {
        ...
        protected override void OnNodeInspectorGUI() {
            ...
            AINodeCanvas.Editor.BBParameterEditor.ParameterField("Sub Dialogue Tree", _subTree);
        ...
        void ShowVariablesMapping() {
            ...
            foreach ( var variable in subTreeVariables ) {
                ...
                AINodeCanvas.Editor.BBParameterEditor.ParameterField(variable.name, bbParam);
            }
