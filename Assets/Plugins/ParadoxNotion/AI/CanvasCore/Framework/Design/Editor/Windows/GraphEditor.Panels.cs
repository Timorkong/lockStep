    ...
    partial class GraphEditor
    {
        ...
        static void ShowGraphCommentsGUI(Graph graph, Vector2 canvasMousePos) {
            if ( Prefs.showComments && !string.IsNullOrEmpty(graph.comments) ) {
                ...
                GUI.Box(new Rect(10, screenHeight - 100, 330, 70), graph.comments, CityNodeCanvas.Editor.StyleSheet.commentsBox);
        ...
        static Rect ShowInspectorGUIPanel(Graph graph, Vector2 canvasMousePos) {
            ...
            if ( GUI.Button(headerRect, string.Empty, CityNodeCanvas.Editor.StyleSheet.button) ) {
                Prefs.showNodePanel = !Prefs.showNodePanel;
            }

            GUI.Box(inspectorPanel, string.Empty, CityNodeCanvas.Editor.StyleSheet.windowShadow);
            ...
            if ( Prefs.showNodePanel ) {
                ...
                GUILayout.BeginArea(inspectorPanel, title, CityNodeCanvas.Editor.StyleSheet.editorPanel);
                GUILayout.Space(5);
                ...
                if ( GUILayout.Button("...", CityNodeCanvas.Editor.StyleSheet.button) ) {
        ...
        static Rect ShowBlackboardGUIPanel(Graph graph, Vector2 canvasMousePos) {
            ...
            GUI.Box(blackboardPanel, string.Empty, CityNodeCanvas.Editor.StyleSheet.windowShadow);
            ...
            if ( Prefs.showBlackboard ) {
                ...
                GUILayout.BeginArea(blackboardPanel, title, CityNodeCanvas.Editor.StyleSheet.editorPanel);
                GUILayout.Space(5);
            ...
            if ( graph.canAcceptVariableDrops && BlackboardEditor.pickedVariable != null && BlackboardEditor.pickedVariableBlackboard == graph.blackboard ) {
                GUI.Label(new Rect(e.mousePosition.x + 15, e.mousePosition.y, 100, 18), "Drop Variable", CityNodeCanvas.Editor.StyleSheet.labelOnCanvas);
