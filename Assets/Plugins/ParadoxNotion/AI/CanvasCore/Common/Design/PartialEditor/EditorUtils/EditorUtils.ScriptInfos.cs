    ...
    partial class EditorUtils
    {
        ...
        public static List<ScriptInfo> GetScriptInfosOfType(Type baseType) {
            ...
            foreach ( var subType in subTypes ) {
                ...
                info.isActorNode = subType.IsDefined(typeof(ActorNodeAttribute), true);
                info.isSceneNode = subType.IsDefined(typeof(SceneNodeAttribute), true);
