...
namespace AIParadoxNotion.Design
{
    ...
    public class NameAttribute : Attribute
    {
        ...
        readonly public int priority;
        public NameAttribute(string name, object priority = null) {
            this.name = name;
            if (priority != null)
            {
    ...
    public class TitleAttribute : Attribute
    {
        ...
        readonly public string runtimeIconTypeCallback;
        readonly public Type fromType;
        public TitleAttribute(string iconName = "", bool fixedColor = false, string runtimeIconTypeCallback = "") {
            this.iconName = iconName;
            this.fixedColor = fixedColor;
            this.runtimeIconTypeCallback = runtimeIconTypeCallback;
        }
        public TitleAttribute(Type fromType) {
            this.fromType = fromType;
        }
    }
    ...
    [AttributeUsage(AttributeTargets.Class)]
    public class ActorNodeAttribute : Attribute { }
