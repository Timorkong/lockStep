...
namespace AIParadoxNotion.Services
{
    ...
    public static class Logger
    {
        ...
        ///Log Info
		public static void Log(object message, System.Enum tag = null, object context = null) {
            Internal_Log(LogType.Log, message, tag.ToString(), context);
        }
        ///Log Info
        ...
        ///Log Warning
        public static void LogWarning(object message, System.Enum tag = null, object context = null) {
            Internal_Log(LogType.Warning, message, tag.ToString(), context);
        }
        ///Log Warning
